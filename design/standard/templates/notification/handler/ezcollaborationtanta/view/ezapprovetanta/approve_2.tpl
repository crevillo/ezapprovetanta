...
{set-block scope=root variable=subject}El contenido "{$objectversion.version_name|wash}" ha sido aprobado{if $notification_creator_object} por "{$notification_creator_object.name|wash}"{/if}{/set-block}
